...
function processVideo() {
  ...
  faceCascade.detectMultiScale(gray, faces, 1.1, 4, 0, msize, msize);

  // Sağa bakan yan profil
  let profilesRight = new cv.RectVector();
  profileCascade.detectMultiScale(gray, profilesRight, 1.1, 4, 0, msize, msize);
  ...
  profileCascade.detectMultiScale(grayFlipped, profilesLeftFlipped, 1.1, 4, 0, msize, msize);
  ...
  for (let i = 0; i < allFaces.length; i++) {
    ...
    eyeCascade.detectMultiScale(roiGray, eyes, 1.1, 4, 0, msize, msize);
